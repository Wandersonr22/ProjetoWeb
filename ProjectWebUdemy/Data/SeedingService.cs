...
using ProjectWebUdemy.Models.Enums;

namespace ProjectWebUdemy.Data
{
    public class SeedingService
    {
        private ProjectWebUdemyContext _context;

        public SeedingService(ProjectWebUdemyContext context)
        {
            _context = context;
        }
